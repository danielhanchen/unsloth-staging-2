...
def escape() -> int:
    ...
    if sys.platform == "win32":
        ...
        term = textwrap.dedent(
            ...
            echo "PR10285_ESC tcp_loopback=$( (timeout 3 bash -c 'exec 3<>/dev/tcp/127.0.0.1/{port}' && echo CONNECTED) 2>&1 | head -c 80)"
            echo "PR10285_ESC tcp_internet=$( (timeout 3 bash -c 'exec 3<>/dev/tcp/1.1.1.1/443' && echo CONNECTED) 2>&1 | head -c 80)"
            echo "PR10285_ESC dns=$(getent hosts example.com 2>&1 | head -c 80)"
