...
# Every failure to resolve the bundle list is fatal. An earlier draft of
# this step warned and exited 0 here, and a self-test caught it letting
# an unscanned release straight through -- the gate reported success
# having scanned nothing at all. A gate that cannot see its input must
# not pass.
