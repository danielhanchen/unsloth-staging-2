...
class FastBaseModel:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # Record whether float32 was ASKED for, as opposed to arrived at by
        # upcasting. Only an explicit request may suppress the float16 autocast
        # that full finetuning relies on for V100/T4 (see rl.py, issue #4082).
