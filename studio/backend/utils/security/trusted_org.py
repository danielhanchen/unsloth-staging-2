...
# Cache keyed on (name, verify_remote) so repeated load attempts don't re-hit
# the Hub. Values are the bool verdict.
_verdict_cache: dict[tuple[str, bool], bool] = {}
